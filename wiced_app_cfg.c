...
const wiced_bt_cfg_settings_t wiced_app_cfg_settings =
{
    ...
    .ble_scan_cfg =                                                 /* BLE scan settings  */
    {
        ...
        .low_duty_scan_duration          = 60,                                                         /**< Low duty scan duration in seconds */
    ...
    .ble_advert_cfg =                                               /* BLE advertisement settings */
    {
        ...
        .low_duty_duration               = 30,                                                         /**< Low duty undirected connectable advertising duration in seconds */
